    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<App />}>
          ...
          <Route path="losgehts/alter" element={<S02Alter />} />
          <Route path="losgehts/postleitzahl" element={<S03Postleitzahl />} />
          ...
          <Route path="losgehts/vorerfahrung" element={<S08Vorerfahrung />} />
          ...
          <Route path="wiewars/nickname" element={<E01NicknameRemember />} />
          ...
          <Route path="wiewars/anything-else" element={<E16AnythingElse />} />
